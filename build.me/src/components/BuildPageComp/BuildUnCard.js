            ...
            <div className="flex flex-col items-center justify-center">
                {(() => {
                    if (addBuildButtonLoad) return (<>
                        <button className="flex flex-row items-start px-10 py-3 text-5xl font-light duration-300 scale-110 bg-indigo-500 rounded-full shadow-lg font-roboto motion-reduce:transform-none"
                        ...
                        <button className="flex flex-row items-start px-10 py-3 text-5xl font-light duration-300 rounded-full font-roboto hover:bg-indigo-500 hover:shadow-lg hover:text-coolGray-100 hover:scale-110 motion-reduce:transform-none" onClick={() => AddingCards()}
