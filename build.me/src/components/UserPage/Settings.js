                            ...
                            {(() => {
                                switch(loadingButtonEmail) {
                                    case true:
                                        return (
                                            <>
                                                <button type="submit" className="inline-flex items-center px-4 py-2 text-base font-medium text-white duration-300 delay-300 bg-teal-400 border border-transparent rounded-md shadow-sm bg-gradient-to-r focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" >
