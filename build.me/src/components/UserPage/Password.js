        ...
        <div className="p-5 bg-white md:flex-1 md:w-full lg:w-full md:ml-10 lg:ml-10 xl:ml-10">
          ...
          <form action="#" className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col items-center justify-center">
                <button className="inline-flex items-center px-8 py-2 text-base font-medium text-white duration-300 delay-300 border border-transparent rounded-md shadow-sm bg-gradient-to-r from-blue-500 to-teal-500 hover:from-blue-700 hover:to-teal-700 focus:outline-none font-poppins">
